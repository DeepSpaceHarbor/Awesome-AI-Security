...
|![][code]|[ShellWard - AI Agent Security Middleware with 8-layer defense: prompt injection detection, data exfiltration chain blocking, dangerous command prevention. Zero dependencies, SDK + plugin](https://github.com/jnMetaCode/shellward)|
