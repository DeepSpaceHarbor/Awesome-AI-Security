...
|![][code]|[AgentStamp - Trust intelligence platform for AI agents. Identity certification, trust scoring (0-100), forensic audit trails, x402 micropayments, MCP server with 14 tools, and ERC-8004 bridge for on-chain agent identity](https://github.com/vinaybhosle/agentstamp)|
