...
|![][code]|[ClawGuard - AI agent immune system with 285+ threat patterns, prompt injection detection (25+ patterns, multilingual), PII sanitizer (100% local), intent-action mismatch detection, and OWASP Agentic AI Top 10 coverage. 229 tests.](https://github.com/NeuZhou/clawguard)|
