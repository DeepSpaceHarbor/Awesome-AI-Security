...
|![][code]|[trentclaw - Open-source security scanner for OpenClaw agent environments. Scans gateway config, tool permissions, MCP servers, plugins, and chained attack paths](https://github.com/trnt-ai/trent-openclaw-security-assessment)|
