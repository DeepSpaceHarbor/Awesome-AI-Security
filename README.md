...
|![][code]|[sofagent - Open-source harness for governing AI coding agents: 24 commit-time audit rules over git diffs, HMAC-signed audit trail, snapshot rollback, MCP server with 79 tools](https://github.com/KongFangXun/sofagent)|
