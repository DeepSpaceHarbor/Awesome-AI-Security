...
|![][code]|[OAST-MCP - OAST tools and agent-management tools for any MCP-compatible AI assistant. It lets an AI drive DNS/HTTP/HTTPS callback detection, deploy agents on compromised targets, and run remote tasks.](https://github.com/dguerri/oast-mcp)|
