...
|![][code]|[Cordum - Open-source agent orchestration platform with runtime AI security: input policy evaluation (deny/escalate/allow), output scanning (PII, secrets, injection), audit trail, and multi-tenant isolation](https://github.com/cordum-io/cordum)|
